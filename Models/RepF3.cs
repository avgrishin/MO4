...
namespace MO.Models
{
  public class RepF3
  {
    ...
    public Stream GetReport()
    {
      ...
      doc.Open();
      Image im = Image.GetInstance(string.Format(@"{0}F3.png", ImagePath));
      ...
      t.AddCell(new PdfPCell(new Phrase("УралСиб Фонд Перспективных вложений", arial10)) { Border = 0 });
      ...
      t.AddCell(new PdfPCell(new Phrase("Индекс РТС 2", arial10)) { Border = 0 });
      ...
      t.AddCell(new PdfPCell(new Phrase("17.06.1999", arial10)) { Border = 0, HorizontalAlignment = Element.ALIGN_RIGHT });
